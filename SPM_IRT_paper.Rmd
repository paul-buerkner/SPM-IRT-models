...
unconstrained scale so are the $b_i$ parameter and we can apply location-scale
...
of the parameter space at which maximum likelhood theory does not hold. In
...
This suggests that, for these specificaly chosen hierarchical and non-hierarchical
...
parameter estimation [see also @loken2010]. Although point estimates very
