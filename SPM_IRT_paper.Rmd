...
```{r person-pars-3pl, fig.height=4, fig.width=8, fig.cap = "Comparison of 3PL person parameters as estimated by brms and mirt. Left: Scatter plot of point estimates. Right: Scatter plot of the associated uncertainty interval widths (UIW)."}
