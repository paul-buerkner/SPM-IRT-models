...
categorized as either right or wrong, we will focus on these binary models in
...
and items parameters independently. We will provide more details on likelihoods
...
(with respect to some Bayesian and/or frequentist criteria), but we would argue
...
paper. To conduct the presented analyses and create this paper, we used the
