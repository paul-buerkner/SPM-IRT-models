---
title: "Bayesian IRT Models for Intelligence Tests"
author: "Paul Bürkner & Marie Beisemann"
output:
  html_document:
    theme: default
encoding: UTF-8
...
fit_1pl <- brm(
  formula = response2 ~ 1 + (1 | item) + (1 | id),
  data = spm_long,
...
person_pars_3pl_fixed <- 
  ranef(fit_3pl_fixed, summary = FALSE)$id[, , "theta_Intercept"]
...
person_pars_4pl_cond <- 
  ranef(fit_4pl_cond, summary = FALSE)$id[, , "theta_Intercept"]
