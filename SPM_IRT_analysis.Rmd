...
fit_1pl <- add_loo(fit_1pl, reloo = TRUE, chains = 1)
```
...
fit_2pl <- add_loo(fit_2pl, reloo = TRUE, chains = 1)
```
...
fit_3pl_fixed <- add_loo(fit_3pl_fixed, reloo = TRUE, chains = 1)
```
...
fit_3pl <- add_loo(fit_3pl, reloo = TRUE, chains = 1)
```
...
fit_4pl <- add_loo(fit_4pl, reloo = TRUE, chains = 1)
```
...
fit_4pl_cond <- add_loo(fit_4pl_cond, reloo = TRUE, chains = 1)
```
